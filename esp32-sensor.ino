...
void dhtPub(float temp, float humi) {
  ...
  String pubDHT = JSON.stringify(json);
  client.publish("/sensor/dht22", pubDHT);
}
...
void gyroPub(float x, float y, float z) {
  ...
  String pubGyro = JSON.stringify(json);
  client.publish("/sensor/mpu6050/gyro", pubGyro);
}
...
void accelPub(float x, float y, float z) {
  ...
  String pubAccel = JSON.stringify(json);
  client.publish("/sensor/mpu6050/accel", pubAccel);
}
